class Post < ApplicationRecord
    ...
    #
    #   # broadcast_prepend_to :posts_list, target: 'all_posts', partial: 'shares/post', locals: { post: self }   #for imigate add to all user but slow down the server
    #   broadcast_prepend_later_to :posts_list, target: 'all_posts', partial: 'shares/post', locals: { post: self }     #faster but may be little delay for some user
    # end
